...
public:
    ...
    Data(){}
    ~Data(){}
    Data(string data_f, string data2_f, string labels_f, string snps_f, string cov_f, string map_f, string edge_f){
    ...
    void load_matrix(string namef, vector<int>& sort_id){
        ...
        while(getline(f, line)){
            ...
            ss_line << line;
            while(ss_line >> value){
                if(value) matrix[row_idx].set( sort_id[col_idx] ); // set matrix[snp][trans] = 1
                col_idx ++;
            }
            ss_line.clear();
            row_idx ++;
    ...
    void load_matrix2(string namef, vector<int>& sort_id){
        ...
        while(getline(f, line)){
            ...
            ss_line << line;
            while(ss_line >> value){
                if(value) matrix2[row_idx].set( sort_id[col_idx] ); // set matrix[snp][trans] = 1
                col_idx ++;
            }
            ss_line.clear();
            row_idx ++;
